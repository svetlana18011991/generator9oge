(function(){
    ...
    const twoNumberText = (pow,num) => `На координатной прямой отмечены числа \\(a\\) и \\(b\\)<br>Какое из следующих утверждений относительно этих чисел является верным?${optRow(['\\(b-a\\lt 0\\)',`\\(a^{${pow}}-b^{${pow}}\\lt 0\\)`,`\\(\\dfrac{${num}}{a}\\lt b\\)`,'\\(a+b\\lt 0\\)'])}`;
        ...
        prototypes: [
            {
                ...
                theory_sol: 'Расположим числа по возрастанию: \\(\\frac97\\approx1{,}29\\lt 1{,}82\\lt \\frac73\\approx2{,}33\\lt 2{,}5\\). Точки на прямой идут слева направо как \\(A,B,C,D\\), поэтому точке \\(B\\) соответствует число \\(1{,}82\\).<br><br><b>Ответ:</b> 3',
                tasks: [
            ...
            },
            {
                ...
                theory_sol: 'Сравним число 53 с квадратами целых чисел: \\(7^2=49\\), \\(8^2=64\\). Так как \\(49\\lt 53\\lt 64\\), получаем \\(7\\lt \\sqrt{53}\\lt 8\\). Значит, число принадлежит промежутку \\([7;8]\\).<br><br><b>Ответ:</b> 4',
                tasks: [
            ...
            },
            {
                ...
                theory_sol: 'Так как \\(7^2=49\\lt 52\\lt 64=8^2\\), число \\(\\sqrt{52}\\) находится между 7 и 8. Приближённо \\(\\sqrt{52}\\approx7{,}21\\), что соответствует точке \\(P\\).<br><br><b>Ответ:</b> 3',
                tasks: [
            ...
            },
            {
                ...
                theory_sol: 'По рисунку \\(0\\lt a\\lt 1\\). При умножении положительного числа, меньшего 1, на \\(a\\) значение уменьшается: \\(a^2\\gt a^3\\gt a^4\\). Поэтому наибольшее число — \\(a^2\\).<br><br><b>Ответ:</b> 1',
                tasks: [
            ...
            },
            {
                ...
                theory_sol: 'По рисунку \\(0\\lt a\\lt b\\lt 1\\). Для положительных чисел возведение в квадрат сохраняет порядок: \\(a^2\\lt b^2\\), поэтому \\(a^2-b^2\\lt 0\\). Остальные утверждения неверны.<br><br><b>Ответ:</b> 2',
                tasks: [
