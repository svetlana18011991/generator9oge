(function() {
    ...
    "prototypes": [
        ...
        },
        {
            ...
            "theory_sol": "Абсцисса точки пересечения — это значение $x$, при котором обе функции принимают одно и то же значение. Поэтому сначала найдём уравнения обеих прямых, а затем приравняем их правые части.<br><br><b>Первая прямая: 1 способ, через тангенс.</b><br><br>\t\t\tВозьмём точки $A(0;1)$ и $B(1;0)$. Через них достроим прямоугольный треугольник: вправо $1$, вниз $1$. Поэтому<br>\\[<br>k_1=\\tg\\alpha_1=\\frac{\\Delta y}{\\Delta x}=\\frac{-1}{1}=-1.<br>\\]<br>Так как точка $A(0;1)$ лежит на прямой, то $b_1=1$. Значит,<br>\\[<br>y=-x+1.<br>\\]<br><br>\t\t\t<b>Вторая прямая: 2 способ, через точки и систему.</b><br><br>\t\t\tВозьмём точки $C(-2;4)$ и $D(-1;-1)$. Пусть уравнение второй прямой имеет вид $y=k_2x+b_2$. Тогда<br>\\[<br>\\begin{cases}<br>4=-2k_2+b_2,\\\\<br>-1=-k_2+b_2.<br>\\end{cases}<br>\\]<br>Вычтем из второго уравнения первое:<br>\\[<br>-1-4=(-k_2+b_2)-(-2k_2+b_2), &nbsp;&nbsp;&nbsp;&nbsp; -5=k_2.<br>\\]<br>Найдём $b_2$:<br>\\[<br>-1=-5\\cdot(-1)+b_2, &nbsp;&nbsp;&nbsp;&nbsp; b_2=-6.<br>\\]<br>Значит,<br>\\[<br>y=-5x-6.<br>\\]<br><br>\t\t\tПриравняем правые части:<br>\\[<br>-x+1=-5x-6, &nbsp;&nbsp;&nbsp;&nbsp; 4x=-7, &nbsp;&nbsp;&nbsp;&nbsp; x=-1{,}75.<br>\\]<br><br>\t\t\t<b>Ответ:</b> $-1{,}75$",
            "tasks": [
                {
        ...
        },
        {
            ...
            "theory_sol": "Найти $f(10)$ — значит найти значение функции при $x=10$. Для этого сначала найдём коэффициент $k$ по отмеченной точке графика, а затем подставим $x=10$.<br><br>Функция имеет вид<br>\\[<br>f(x)=\\frac{k}{x}.<br>\\]<br><br>\t\t\tПо графику возьмём отмеченную точку $(2;1)$. Подставим её координаты:<br>\\[<br>1=\\frac{k}{2}, &nbsp;&nbsp;&nbsp;&nbsp; k=2.<br>\\]<br>Значит,<br>\\[<br>f(x)=\\frac{2}{x}.<br>\\]<br><br>\t\t\tНайдём значение функции:<br>\\[<br>f(10)=\\frac{2}{10}=0{,}2.<br>\\]<br><br>\t\t\t<b>Ответ:</b> $0{,}2$",
            "tasks": [
                {
